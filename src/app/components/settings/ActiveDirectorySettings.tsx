...
export default function ActiveDirectorySettings() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold text-gray-900 mb-2">Настройка Active Directory</h3>
      ...
      <div className="space-y-4">
        {domains.map((domain, index) => (
          <div key={domain.id} className="bg-gray-50 border border-gray-200 rounded-lg p-4">
            <div className="flex items-center justify-between mb-4">
              <h4 className="font-semibold text-gray-900">Домен {index + 1}</h4>
              <button
