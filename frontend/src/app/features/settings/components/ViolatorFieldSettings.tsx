...
export default function ViolatorFieldSettings() {
  const {
    baseFields,
    extraFields,
    setBaseFields,
  ...
  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Настройка полей нарушителей</h3>
        <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">
          Создайте и настройте поля для нарушителей. Системные поля (ФИО, Email, SAM Account Name, Домен) нельзя удалить.
        </p>
      </div>
