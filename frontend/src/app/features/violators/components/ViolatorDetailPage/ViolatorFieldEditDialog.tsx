...
import { getFileIconLarge } from '../../../incidents/utils/fileIcons.tsx';
import {
  Dialog,
  DialogContent,
  DialogFooter,
...
interface ViolatorFieldEditDialogProps {
  open: boolean;
...
export default function ViolatorFieldEditDialog({
  open,
  onOpenChange,
  label,
  value,
